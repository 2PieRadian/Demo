...
function ProfileHoverCard() {
  return (
    <div className="absolute top-[50px] dark:bg-dark-card dark:shadow-[0px_0px_5px_rgba(255,255,255,0.4)] shadow-[0px_0px_5px_0px_#9e9e9e] dark:text-white text-gray-700 right-[0] rounded-[7px] flex flex-col bg-[#fff] w-[300px]">
